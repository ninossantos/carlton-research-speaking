...
export const TALKS: Talk[] = [
  ...
  },
  {
    ...
    opening: [
      { at: 0, line: "Repetition, calibrated to the record.", prongs: [true, false, false, false], visual: "lock" },
      { at: 2800, line: "Relatedness: one course, not a pile.", prongs: [true, true, false, false], visual: "lock" },
      { at: 5600, line: "Continuity across the corpus.", prongs: [true, true, true, false], visual: "lock" },
      { at: 8400, line: "Asymmetry, or the pattern fails.", prongs: [true, true, true, true], visual: "lock" },
      {
        at: 11800,
